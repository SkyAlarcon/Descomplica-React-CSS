...
const initialRows = [
  ...
  createData(3, 'Tarefa 3', 'Descrição da Tarefa 3', '2022-01-04', '2022-01-05', 'Backlog', 'Recurso 3'),
  createData(4, 'Tarefa 4', 'Descrição da Tarefa 4', '2022-01-05', '2022-01-06', 'Backlog', 'Recurso 4'),
  createData(5, 'Tarefa 5', 'Descrição da Tarefa 5', '2022-01-06', '2022-01-07', 'Em Andamento', 'Recurso 5'),
  createData(6, 'Tarefa 6', 'Descrição da Tarefa 6', '2022-01-07', '2022-01-08', 'Aguardando cliente', 'Recurso 6'),
];
        ...
        <CardContent>
            ...
            <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
                ...
                {tarefas.map((row, indice) => (
                    ...
                    >
                      <TableCell component="th" scope="row" className={row.statusTarefa === "Concluída" ? "text-strike bg-gray" : ""}>
                          {row.idTarefa}
                      </TableCell>
                      <TableCell component="th" scope="row" className={row.statusTarefa === "Concluída" ? "text-strike bg-gray" : ""}>
                          {row.tituloTarefa}
                      </TableCell>
                      <TableCell align="right" className={row.statusTarefa === "Concluída" ? "text-strike bg-gray" : ""}>{row.descricaoTarefa}</TableCell>
                      <TableCell align="right" className={row.statusTarefa === "Concluída" ? "text-strike bg-gray" : ""}>{row.inicioTarefa}</TableCell>
                      <TableCell align="right" className={row.statusTarefa === "Concluída" ? "text-strike bg-gray" : ""}>{row.fimTarefa}</TableCell>
                      <TableCell align="right" className={row.statusTarefa === "Concluída" ? "text-strike bg-gray" : ""}>{row.statusTarefa}</TableCell>
                      <TableCell align="center" className={row.statusTarefa === "Concluída" ? "bg-gray" : ""}>
